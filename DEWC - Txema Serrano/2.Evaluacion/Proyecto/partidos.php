...
<body>
    ...
    <div class="container">
        <div class="table-wrapper">
            ...
            <div class='col-12'>
                <div id="wg-api-football-fixtures" data-host="v3.football.api-sports.io" data-refresh="60" data-date="<?php echo date("Y-m-d"); ?>" data-league="" data-team="" data-season="" data-last="" data-next="" data-key="e332e51a7d76ff7aa8307fbc2fd5b413" data-theme="" data-show-errors="false" class="api_football_loader">
                </div>
            </div>
        </div>
    </div>
